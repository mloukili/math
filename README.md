...
This is equivalent to say: find a sub array in a list of numbers where the sum of this subset equals to (S + M) / 2. Where S is the the sum of all numbers and M is the magic number we are looking for.
...
<img src="assets/magic-number-proof.jpeg" width="100%" alt="Proof">
